...
namespace SwaggyMods
{
    public class Main : Script
    {
        ObjectPool menuPool = new ObjectPool();
        NativeMenu mainMenu = new NativeMenu("SwaggyMods", "Main Menu");
        NativeMenu playerMenu = new NativeMenu("SwaggyMods", "Player Menu");
        NativeMenu vehicleSpawnerMenu = new NativeMenu("SwaggyMods", "Vehicle Spawner Menu");
        NativeMenu weaponsMenu = new NativeMenu("SwaggyMods", "Weapons Menu");
